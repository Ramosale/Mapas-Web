...
var features_RiosDelChubut_1 = format_RiosDelChubut_1.readFeatures(json_RiosDelChubut_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiosDelChubut_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiosDelChubut_1.addFeatures(features_RiosDelChubut_1);
var lyr_RiosDelChubut_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiosDelChubut_1, 
                style: style_RiosDelChubut_1,
                popuplayertitle: 'RiosDelChubut',
                interactive: true,
                title: '<img src="styles/legend/RiosDelChubut_1.png" /> RiosDelChubut'
            });
var format_LocalidadesCHUBUT_2 = new ol.format.GeoJSON();
var features_LocalidadesCHUBUT_2 = format_LocalidadesCHUBUT_2.readFeatures(json_LocalidadesCHUBUT_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_LocalidadesCHUBUT_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LocalidadesCHUBUT_2.addFeatures(features_LocalidadesCHUBUT_2);
var lyr_LocalidadesCHUBUT_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LocalidadesCHUBUT_2, 
                style: style_LocalidadesCHUBUT_2,
                popuplayertitle: 'LocalidadesCHUBUT',
                interactive: true,
                title: '<img src="styles/legend/LocalidadesCHUBUT_2.png" /> LocalidadesCHUBUT'
            });

lyr_UnidadesVegetacionChubut_0.setVisible(true);lyr_RiosDelChubut_1.setVisible(true);lyr_LocalidadesCHUBUT_2.setVisible(true);
var layersList = [lyr_UnidadesVegetacionChubut_0,lyr_RiosDelChubut_1,lyr_LocalidadesCHUBUT_2];
lyr_UnidadesVegetacionChubut_0.set('fieldAliases', {'CODIGO': 'CODIGO', 'REGION': 'REGION', 'DOMINIO': 'DOMINIO', 'UNID_FITOG': 'UNID_FITOG', 'NOMFISONOM': 'Tipo de Vegetación', 'NOMVULGAR': 'NOMVULGAR', 'SUP_HA': 'SUP_HA', 'X': 'X', 'Y': 'Y', 'ROTATION': 'ROTATION', });
lyr_RiosDelChubut_1.set('fieldAliases', {'RIO_PER_': 'RIO_PER_', 'NOMBRE': 'NOMBRE', 'CUENCA': 'CUENCA', });
lyr_LocalidadesCHUBUT_2.set('fieldAliases', {'gid': 'gid', 'nombre_geo': 'Localidades', 'tipo_asent': 'tipo_asent', 'codigo_ase': 'codigo_ase', 'nombre_agl': 'nombre_agl', 'codigo_agl': 'codigo_agl', 'nombre_dep': 'nombre_dep', 'codigo_ind': 'codigo_ind', 'nombre_pro': 'nombre_pro', 'codigo_in0': 'codigo_in0', 'latitud_gr': 'latitud_gr', 'longitud_g': 'longitud_g', 'latitud_g0': 'latitud_g0', 'longitud_0': 'longitud_0', 'fuente_de_': 'fuente_de_', });
...
lyr_RiosDelChubut_1.set('fieldLabels', {'RIO_PER_': 'hidden field', 'NOMBRE': 'no label', 'CUENCA': 'no label', });
lyr_LocalidadesCHUBUT_2.set('fieldLabels', {'gid': 'hidden field', 'nombre_geo': 'inline label - always visible', 'tipo_asent': 'hidden field', 'codigo_ase': 'hidden field', 'nombre_agl': 'hidden field', 'codigo_agl': 'hidden field', 'nombre_dep': 'hidden field', 'codigo_ind': 'hidden field', 'nombre_pro': 'hidden field', 'codigo_in0': 'hidden field', 'latitud_gr': 'hidden field', 'longitud_g': 'hidden field', 'latitud_g0': 'hidden field', 'longitud_0': 'hidden field', 'fuente_de_': 'hidden field', });
lyr_LocalidadesCHUBUT_2.on('precompose', function(evt) {
