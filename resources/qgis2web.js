...
map.getView().fit([-8273972.172193, -5859620.517376, -6683639.256004, -5090166.346743], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Unidad de Vegetación </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (31 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ramos Alejandra Lic. Geografia ';
            }
